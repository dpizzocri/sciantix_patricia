...
void Initialization()
{
	...
	// projection on diffusion modes of the initial conditions // mod Giorgi - to correctly work with non-null He initial conditions at grain boundary (GB solution / GB bubbles)

...
void InterGranularBubbleEvolution( )
{
  ...
  // Gas is distributed among present bubbles
  ...
  const double source_term(0.0);
  const double dbubble_area = Intergranular_bubble_area[1] - Intergranular_bubble_area[0];
  Intergranular_bubble_concentration[1] = Solver::BinaryInteraction(Intergranular_bubble_concentration[0], geometric_coefficient, source_term, dbubble_area);
